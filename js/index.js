                ...
                <div class="product-grid">
                    <div class="product-image">
                        ...
                        <ul class="product-links">
                            <li><a href="#" data-tip="Agregar a favoritos" data-bs-toggle="modal" data-bs-target="#wishlistModal"><i class="bi bi-heart"></i></a></li>
                        </ul>
                        <button data-id="${product.id}" class="add-to-cart" href="#">Agregar al carrito</button>
                    </div>
    ...
    addCartItem(item) {
        ...
        <img src="${item.image}" alt="">
            <div class="pushbar__text">
                ...
                <a href="#" class="pushbar__delete text-decoration-none text-light" data-id=${item.id}>Borrar</a>
            </div>
        `;
